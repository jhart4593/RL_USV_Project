...
# plotCourseAngle(simData_total,simTime,eval_config["target_course_angle"])
# plotActionsCourseAngle(kp_total,ki_total,kd_total,simTime)


# simData_total, simTime = sim_otter_course_angle()
# plotCourseAngle(simData_total,simTime,eval_config["target_course_angle"])
...
# plotTraj(simData,simTime,eval_config["path_x"],eval_config["path_y"],'2','')
# plotStates(simData,simTime,'2','')
# plotControls(simData,simTime,'2','')
# plotActionsTraj(act,simTime,'2','')


simTime, simData = sim_otter_LOS(eval_config["path_x"],eval_config["path_y"])
plotTraj(simData,simTime,eval_config["path_x"],eval_config["path_y"],'2','')
...
# plotTraj(simData,simTime,eval_config["path_x1"],eval_config["path_y1"],'3','M')
