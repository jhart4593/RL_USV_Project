...
import numpy as np
import math
from fossen_gnc import Smtrx, Hmtrx, Rzyx, m2c, crossFlowDrag, sat, PIDpolePlacement, simulate, attitudeEuler
...
class otter:
    ...
    def dynamics(self, eta, nu, u_actual, u_control, sampleTime, Vc, beta_c):
        """
        ...
        # Current velocities
        u_c = Vc * math.cos(beta_c - eta[5])  # current surge vel.
        v_c = Vc * math.sin(beta_c - eta[5])  # current sway vel.
